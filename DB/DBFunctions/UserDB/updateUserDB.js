 ...
 *
 * @precondition The `user_id` must correspond to an existing user in the database.
...
async function updateUserDB(user_id, fields = {}) {
  console.log(user_id);
  console.log(fields);
  ...
  try {
    ...
    const {
      ...
      `
        ...
        SET ${setString}
        WHERE id=${user_id}
        RETURNING username, first_name, last_name, preferred_name, phone, email, admin;
        `,
